...
n?n.prefixValue=t:this._globalPrefixes=[].concat(s(this._globalPrefixes),[{prefixName:e,prefixValue:t}]).sort((function(e,t){return t.prefixName.localeCompare(e.prefixName)})),this._trackedLocalStorage.triggerRerender()}},{key:"getItem",value:function(e,t){try{return this._validateKey(e),this._trackedLocalStorage.getItem(this._getPrefixedKey(e,t))}catch(n){console.error(n)}}},{key:"setItem",value:function(e,t,n){try{this._validateKey(e),this._trackedLocalStorage.setItem(this._getPrefixedKey(e,n),t)}catch(r){console.error(r)}}},{key:"removeItem",value:function(e,t){try{this._validateKey(e),this._trackedLocalStorage.removeItem(this._getPrefixedKey(e,t))}catch(n){console.error(n)}}},{key:"_getPrefixedKey",value:function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:[]
...
e.default=O})),define("ember-tracked-local-storage/utils/tracked-in-local-storage",["exports","macro-decorators"],(function(e,t){"use strict"
function n(e){var t=e.keyName,n=e.defaultValue,r=e.skipPrefixes,o=i(this).getItem(t,r)
return Ember.isNone(o)?n:o}function r(e){var t=e.keyName,n=e.defaultValue,r=e.value,o=e.skipPrefixes,a=i(this)
return r===n||void 0===r?a.removeItem(t,o):a.setItem(t,r,o),r}function i(e){return(e.owner||Ember.getOwner(e)).lookup("service:tracked-local-storage")}Object.defineProperty(e,"__esModule",{value:!0}),e.trackedInLocalStorage=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},i=e.keyName,o=e.keyNameProperty,a=e.defaultValue,s=e.skipPrefixes,u=void 0===s?[]:s
return(0,t.default)({get:function(e,t){var r=this[o]||i||t
return n.call(this,{keyName:r,defaultValue:a,skipPrefixes:u})},set:function(e,t,n){var s=this[o]||i||t
return r.call(this,{keyName:s,defaultValue:a,value:n,skipPrefixes:u})}})},e.localStorageGet=n,e.localStorageSet=r})),define("ember-tracked-local-storage/utils/tracked-local-storage",["exports","macro-decorators"],(function(e,t){"use strict"
var n,r,i,o,a,s
...
if(t===p)return null
try{return JSON.parse(t)}catch(n){return t}}},{key:"setItem",value:function(e,t){var n=JSON.stringify(t)
this._getCell(e).value=n,this._localStorage.setItem(e,n)}},{key:"removeItem",value:function(e){null!==this.getItem(e)&&(this._dirtyCell(this._getCell(e)),this._localStorage.removeItem(e))}},{key:"clear",value:function(){Object.values(this._cellsMap).forEach(this._dirtyCell),this._localStorage.clear()}},{key:"triggerRerender",value:function(){Object.values(this._cellsMap).forEach((function(e){var t=e.value
